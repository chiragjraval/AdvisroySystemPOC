...
public class HistoricalIndexData implements Serializable {
	 ...
	 * @param turnover
	 */
	public HistoricalIndexData(String indexName, Date date, Double openPrice, Double highPrice, Double lowPrice,
									Double closePrice, Double adjClosePrice, Double monthlyReturn, Double sharesTraded, Double turnover){
	...
	public String toString() {
		return "HistoricalIndexData[" + indexName + "," + date + "," + openPrice
				+ highPrice + "," + lowPrice + "," + closePrice + "," + monthlyReturn 
